...
public class PdfBooleanDeserializer implements IPdfObjectDeserializer<PdfBoolean> {

    private boolean value;

    public PdfBooleanDeserializer(boolean value) {
        this.value = value;
    }

    @Override
    public PdfBoolean deserialize(PdfTokenizer tokens, DeserializationContext context, boolean readAsDirectObject) {
