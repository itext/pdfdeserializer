...
public class PdfNullDeserializer implements IPdfObjectDeserializer<PdfNull> {
    @Override
    public PdfNull deserialize(PdfTokenizer tokens, DeserializationContext context, boolean readAsDirectObject) {
