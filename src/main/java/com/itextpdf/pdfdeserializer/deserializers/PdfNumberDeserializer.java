...
public class PdfNumberDeserializer implements IPdfObjectDeserializer<PdfNumber> {
    @Override
    public PdfNumber deserialize(PdfTokenizer tokens, DeserializationContext context, boolean readAsDirectObject) {
