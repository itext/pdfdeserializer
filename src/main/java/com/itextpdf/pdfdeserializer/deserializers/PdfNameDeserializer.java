...
public class PdfNameDeserializer implements IPdfObjectDeserializer<PdfName> {
    @Override
    public PdfName deserialize(PdfTokenizer tokens, DeserializationContext context, boolean readAsDirectObject) {
        if (readAsDirectObject) {
