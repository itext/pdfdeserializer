...
public class DeserializationContext {
    ...
    public DeserializationContext() {
        this.strictnessLevel = StrictnessLevel.CONSERVATIVE;
    }
    ...
    public DeserializationContext setPdfDocument(PdfDocument pdfDocument) {
    ...
    public DeserializationContext setStrictnessLevel(StrictnessLevel strictnessLevel) {
